        ...
        return this.each(function () {
            ...
            function i(t) {
                ...
                if ("1" == l.animate_text_colors)
                    var a = l.fgcolor;
                e("<span></span>").appendTo(t).html(r).css({ "line-height": l.size + "px", "font-size": .22 * l.size + "px", color: a });
            }
            function f(t) {
            ...
            if (l.fgcolor = t(h), l.color && (l.fgcolor = l.color), void 0 != p.data("text") ? (r = void 0 != p.data("append") || "" != p.data("append") && null != p.data("append") ? p.data("text").toString() + "<u>" + p.data("append") + "</u>" : p.data("text"), (void 0 != p.data("prepend") || "" != p.data("prepend") && null != p.data("prepend")) && (r = "<s>" + p.data("prepend") + "</s>" + r.toString()), i(p)) : (void 0 != p.data("prepend") || "" != p.data("prepend") && null != p.data("prepend") ? (r = "<s>" + p.data("prepend") + "</s>" + p.data("percent").toString(), (void 0 != p.data("append") || "" != p.data("append") && null != p.data("append")) && (r = r.toString() + "<u>" + p.data("append") + "</u>")) : (r = p.data("percent"), (void 0 != p.data("append") || "" != p.data("append") && null != p.data("append")) && (r = r.toString() + "<u>" + p.data("append") + "</u>")), i(p)), void 0 != e(this).data("total") && void 0 != e(this).data("used")) {
                ...
                void 0 != e(this).data("percent") ? (percent = e(this).data("percent") / 100, c = e(this).data("percent")) : percent = a.percent / 100;
            ...
            var b = e("<canvas></canvas>").attr({ width: l.size, height: l.size }).appendTo(e(this)).get(0), g = b.getContext("2d"), m = b.width / 2, v = b.height / 2, _ = 360 * l.percent, x = (_ * (Math.PI / 180), b.width / 2.5), k = 2.3 * Math.PI, G = 0, M = 0 === l.animationstep ? c : 0, z = Math.max(l.animationstep, 0), P = 2 * Math.PI, I = Math.PI / 2, R = "";
            if (void 0 != e(this).data("style")) {
                if (R = e(this).data("style"), "Semi" == R)
                    var k = 2 * Math.PI, G = 3.13, P = 1 * Math.PI, I = Math.PI / .996;
                if ("Arch" == R)
                    var k = 2.195 * Math.PI, G = 1, G = 655.99999, P = 1.4 * Math.PI, I = Math.PI / .8335;
            }
            n(M / 100);
        });
    };
